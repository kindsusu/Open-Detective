...
The generator and the plan's eligible-query queue both alternate full identity, industry context, and function context families while retaining order inside each family. Short or broad forms remain later work. This is a bounded scheduling heuristic: an earlier full spelling can be delayed, and it does not claim exhaustive or optimal recall.
